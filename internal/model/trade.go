...
type ProtectionAdjustment struct {
	Role       string `json:"role"` // "stopLoss" | "takeProfit"
	Ts         int64  `json:"ts"`
...
type Trade struct {
	...
	InitialStopTicks       *int64                 `json:"initialStopTicks"`
	InitialTakeProfitTicks *int64                 `json:"initialTakeProfitTicks"`
	ProtectionAdjustments  []ProtectionAdjustment `json:"protectionAdjustments"`
