import { Activity, ChevronDown, PanelRightClose, PanelRightOpen, Rewind, Search } from 'lucide-react'
  ...
  return (
    <header className="flex h-11 shrink-0 items-stretch border-b border-line bg-[#101114]" aria-label="Workspace controls">
      <div className="flex min-w-0 flex-1 items-center gap-1 overflow-x-auto px-2 [scrollbar-width:none] md:gap-2 md:px-3">
        <a href="#chart-workspace" className="mr-2 flex shrink-0 items-center gap-2 text-ui-title font-semibold tracking-[-0.01em] text-ink">
        ...
        <div className="relative shrink-0">
          ...
          <select
            ...
            disabled={evalLocked}
            value={replay.symbol}
            onChange={(event) => void replayEngine.selectSymbol(event.target.value)}
